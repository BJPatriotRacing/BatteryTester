...
void setup() {
  ...
  InputNumberPad.init(C_BLACK, C_WHITE, C_BLUE, C_DKBLUE, C_WHITE, C_CYAN, C_YELLOW, FONT_HEADING);
  ...
  InputNumberPad.enableClick(BUZZ_PIN);
  InputNumberPad.setRotation(0);
